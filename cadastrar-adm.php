        ...
        <div class="container-fluid">
            <div class="row justify-content-center mt-4">
                <div class="col-lg-9 mx-auto mbr-form" data-form-type="formoid">
                    <form action="./actions/cadastrar-adm.php" method="POST" class="mbr-form form-with-styler mx-auto"
                        ...
                        <div class="dragArea row">
							<div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="nome">
                                <input type="text" name="nome" placeholder="Nome" data-form-field="nome"
                                    class="form-control" value="" id="nome-form7-x" />
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="email">
                                <input type="email" name="email" placeholder="Email" data-form-field="email"
                                    class="form-control" value="" id="email-form7-x" />
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                                <input type="password" name="senha" data-form-field="password"
                                placeholder="Senha" class="form-control" value="" id="password-form7-x" />
                            </div>
							...
							<div class="col-auto mbr-section-btn align-center">
                                <button type="reset" class="btn btn-primary-outline display-4">
                                    Limpar
                                </button>
                            </div>
                        </div>
