...
>
  ...
  <div class="row">
    ...
    <div class="form-floating">
      <textarea class="form-control" placeholder="Para que serve o produto?" id="txtDescricao" name="txtDescricao" style="height: 100px"></textarea>
      <label for="txtDescricao">Descrição</label>
    </div>

    <div class="form-floating">
      <textarea class="form-control" placeholder="Escreva uma Observação..." id="txtObservacao" name="txtObservacao" style="height: 100px"></textarea>
